...
export class FarmersListPageComponent implements OnInit {
  ...
  proceedFromPersonalDetails() {
    this.farmerFormData.first_name = this.personalFormGroup.controls['firstNameCtrl'].value;
    this.farmerFormData.surname = this.personalFormGroup.controls['surnameCtrl'].value;
    this.farmerFormData.middle_name = this.personalFormGroup.controls['middleNameCtrl'].value;
    this.farmerFormData.sex = this.personalFormGroup.controls['genderControl'].value;
    this.farmerFormData.date_of_birth = this.personalFormGroup.controls['birthDateCtrl'].value;
    this.farmerFormData.id_card.type = this.personalFormGroup.controls['idsControl'].value;
    this.farmerFormData.id_card.number = this.personalFormGroup.controls['idNumberCtrl'].value;
    this.farmerFormData.is_absentee_farmer = this.personalFormGroup.controls['isAbsenteeCtrl'].value;
    this.farmerFormData.caretaker.name = this.personalFormGroup.controls['caretakerNameCtrl'].value;
    this.farmerFormData.caretaker.phone_number = this.personalFormGroup.controls['caretakerPhoneCtrl'].value;
    this.farmerFormData.physical_address.town_village_settlement = this.personalFormGroup.controls['settlementCtrl'].value;
    this.farmerFormData.physical_address.road_street_trace_address = this.personalFormGroup.controls['streetCtrl'].value;
    this.farmerFormData.physical_address.district_province = this.personalFormGroup.controls['districtCtrl'].value;
    this.farmerFormData.physical_address.house_number = this.personalFormGroup.controls['houseCtrl'].value;
    this.farmerFormData.physical_address.region = this.personalFormGroup.controls['regionCtrl'].value;
    this.farmerFormData.physical_address.country = this.personalFormGroup.controls['countryCtrl'].value;
    this.farmerFormData.postal_address.postal_office_box = this.personalFormGroup.controls['postalOfficeCtrl'].value;
    this.farmerFormData.postal_address.town_village_settlement = this.personalFormGroup.controls['postalTownCtrl'].value;
    this.farmerFormData.postal_address.street_road_trace_sentence = this.personalFormGroup.controls['postalStreetCtrl'].value;
  ...
  saveFarmer() {
    ...
    if (this.bankInfoForm.invalid) {
      this.appService.openSnackBar("Complete bank details. All fields marked with asteriks * are required", "Done")
    } else {
      this.farmerFormData.bank_info.account_type = this.bankInfoForm.controls['accountTypeCtrl'].value;
      this.farmerFormData.bank_info.account_name = this.bankInfoForm.controls['accountNameCtrl'].value;
      this.farmerFormData.bank_info.account_number = this.bankInfoForm.controls['accountNumberCtrl'].value;
      this.farmerFormData.bank_info.bic_swift_code = this.bankInfoForm.controls['bicSwiftCodeCtrl'].value;
      this.farmerFormData.bank_info.bank_name = this.bankInfoForm.controls['bankNameCtrl'].value;
      this.farmerFormData.bank_info.branch_name = this.bankInfoForm.controls['branchNameCtrl'].value;
      this.farmerFormData.bank_info.branch_address = this.bankInfoForm.controls['branchAddressCtrl'].value;
      this.farmerFormData.bank_info.bank_phone_number = this.bankInfoForm.controls['bankPhoneCtrl'].value;
      console.log(this.farmerFormData)
